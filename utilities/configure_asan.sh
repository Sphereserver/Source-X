...
ASAN_OPTIONS="${_SAN_COMMON_FLAGS}"
ASAN_OPTIONS+=":strict_init_order=true:detect_stack_use_after_return=true"
ASAN_OPTIONS+=":sleep_before_dying=3:print_stats=true:stack_trace_format=\"[frame=%n, function=%f, location=%S]\""
export ASAN_OPTIONS
