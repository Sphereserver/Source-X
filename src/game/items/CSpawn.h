...
private:
    ...
    word m_iAmount;           // Amount of objects to spawn.
    ...
    word    m_pile;             // more2=The max # of items to spawn per interval.  If this is 0, spawn up to the total amount (Only for Item's Spawn).
