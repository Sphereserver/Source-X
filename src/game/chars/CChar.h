...
private:
	...
	CChar * Spell_Summon( CChar * pChar, CPointMap ptTarg );
...
public:
	...
	CChar * Spell_CanSummon(SPELL_TYPE spell, CPointMap ptTarg, CREID_TYPE iC1);
...
public:
	...
	static int CalcPercentArmorDefence(LAYER_TYPE layer);
