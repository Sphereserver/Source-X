                ...
                if (GetTopDist3D(pSrc) <= 2)
                {
                    ...
                    if (pReactive)
                    {
                        if (IsTrigUsed(TRIGGER_HITREACTIVE))
                        {
                            ...
                            HitReactiveArgs.m_VarsLocal.SetNum("RedDam", iReactiveRedDam);    // REDUCED DAM
                            ...
                            iReactiveRedDam  = (int)HitReactiveArgs.m_VarsLocal.GetKeyNum("RedDam");                  // REDUCED DAM
                            ...
                            pSrc->OnTakeDamage(
                                ...
                                iDmgPoison,
                                iDmgEnergy,
                                (SPELL_TYPE)pReactive->m_itSpell.m_spell);
