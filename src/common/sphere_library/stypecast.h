...
constexpr Tout enum_alias_cast(const Tin source_val) noexcept
{
    ...
    static_assert(!(std::is_signed_v    <detail_stypecast::underlying_or_self_t<Tin>> &&
                    std::is_unsigned_v  <detail_stypecast::underlying_or_self_t<Tout>>),
        "Casting signed to unsigned.");
    static_assert(!(std::is_signed_v    <detail_stypecast::underlying_or_self_t<Tout>> &&
                    std::is_unsigned_v  <detail_stypecast::underlying_or_self_t<Tin>> ),
...
template <typename T>
[[nodiscard]]
constexpr auto enum64_narrow_n32_checked(const T source_val, bool should_assert = false) noexcept
{
    static_assert(std::is_enum_v<T>, "Input variable is not an enum type.");
...
template <typename T>
[[nodiscard]]
constexpr auto enum64_narrow_n16_checked(const T source_val, bool should_assert = false) noexcept
{
    static_assert(std::is_enum_v<T>, "Input variable is not an enum type.");
...
template <typename T>
[[nodiscard]]
constexpr auto enum64_narrow_n8_checked(const T source_val, bool should_assert = false) noexcept
{
    static_assert(std::is_enum_v<T>, "Input variable is not an enum type.");
...
template <typename T>
[[nodiscard]]
constexpr auto enum32_narrow_n16_checked(const T source_val, bool should_assert = false) noexcept
{
    static_assert(std::is_enum_v<T>, "Input variable is not an enum type.");
...
template <typename T>
[[nodiscard]]
constexpr auto enum32_narrow_n8_checked(const T source_val, bool should_assert = false) noexcept
{
    static_assert(std::is_enum_v<T>, "Input variable is not an enum type.");
...
template <typename T>
[[nodiscard]]
constexpr auto enum16_narrow_n8_checked(const T source_val, bool should_assert= false) noexcept
{
    static_assert(std::is_enum_v<T>, "Input variable is not an enum type.");
