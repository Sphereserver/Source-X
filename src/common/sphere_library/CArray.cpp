...
CGObList * CGObListRec::GetParent() const
{
	return m_pParent;
}

CGObListRec * CGObListRec::GetNext() const
{
	return m_pNext;
}

CGObListRec * CGObListRec::GetPrev() const
{
	return m_pPrev;
}

// CGObList:: Constructors, Destructor, Asign operator.
