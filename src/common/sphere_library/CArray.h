...
class CGObSortArray : public CGObArray<TYPE>
{
	/** @name Constructors, Destructor, Asign operator:
	 */
	///@{
...
// CGTypedArray:: Constructors, Destructor, Asign operator.
...
// CGTypedArray:: Operations.

template<class TYPE, class ARG_TYPE>
inline size_t CGTypedArray<TYPE, ARG_TYPE>::BadIndex() const
{
	return (std::numeric_limits<size_t>::max)();
}

template<class TYPE, class ARG_TYPE>
TYPE * CGTypedArray<TYPE,ARG_TYPE>::GetBasePtr() const
{
	return m_pData;
}
...
// CGPtrTypeArray:: Constructors, Destructor, Asign operator.

template<class TYPE>
CGPtrTypeArray<TYPE>::CGPtrTypeArray() {
...
// CGObArray:: Constructors, Destructor, Asign operator.
...
// CGObSortArray:: Constructors, Destructor, Asign operator.

template<class TYPE,class KEY_TYPE>
CGObSortArray<TYPE,KEY_TYPE>::CGObSortArray()
{
}
