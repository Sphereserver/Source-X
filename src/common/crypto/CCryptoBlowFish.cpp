...
const dword CCrypto::sm_dwInitData[18+1024] =
{
	// @0106248 in v2.0.3
...
const byte CCrypto::sm_key_table[CRYPT_GAMEKEY_COUNT][CRYPT_GAMEKEY_LENGTH] =
{
	// @ 0f1420 in v2.0.3
...
const byte CCrypto::sm_seed_table[2][CRYPT_GAMEKEY_COUNT][2][CRYPT_GAMESEED_LENGTH] =
{
